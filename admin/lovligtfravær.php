...
if ($row['areYouSick'] !== 2){ 
    $sql = "UPDATE kortlog SET areYouSick =2 WHERE Kortdata ='".$_POST['studentId']."' AND dag ='".$_POST['date']."'";
    $result = mysqli_query($conn,$sql);
    echo " Du er syg";
    ...
    { 
        ...
        echo $sql = "INSERT INTO kortlog (tid, dag, Kortdata,tidTimeStamp,Kommentar, areYouSick) VALUES ( '".date('H.i.s')."', '".$_POST['date']."', '".$_POST['studentId']."','".date('Y-m-d H:m:s')."','dood', 2 )";
        $result = mysqli_query($conn,$sql);  
    }
}
